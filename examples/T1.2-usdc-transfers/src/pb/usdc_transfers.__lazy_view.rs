...
/** Lazy view of `usdc.transfers.v1.UsdcTransfers`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `UsdcTransfersView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `UsdcTransfersView`-family
 ...
 let view = UsdcTransfersLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct UsdcTransfersLazyView<'a> {
    /// Field 1: `transfers`
    pub transfers: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::UsdcTransferLazyView<'a>,
    >,
}
impl<'a> UsdcTransfersLazyView<'a> {
...
impl<'a> ::buffa::LazyMessageView<'a> for UsdcTransfersLazyView<'a> {
...
impl<'a> ::buffa::MessageName for UsdcTransfersLazyView<'a> {
...
/** Lazy view of `usdc.transfers.v1.UsdcTransfer`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `UsdcTransferView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `UsdcTransferView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = UsdcTransferLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct UsdcTransferLazyView<'a> {
    /// Field 1: `tx_hash`
    pub tx_hash: &'a str,
    /// Field 2: `log_index`
    pub log_index: u64,
...
impl<'a> ::buffa::LazyMessageView<'a> for UsdcTransferLazyView<'a> {
...
impl<'a> ::buffa::MessageName for UsdcTransferLazyView<'a> {
    const PACKAGE: &'static str = "usdc.transfers.v1";
